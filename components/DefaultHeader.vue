    ...
    <div class="header__container">
      ...
      <div class="header__desktop-nav">
        ...
        <div class="header__actions">
          ...
          <button>
            <ShoppingCartIcon class="header__action-icon" @click="toggleShoppingBag" />
          </button>
      ...
      <div class="header__mobile-controls">
        <button>
          <ShoppingCartIcon class="header__mobile-icon" @click="toggleShoppingBag" />
        </button>
        <button class="header__menu-button" @click="toggleDropdown">
