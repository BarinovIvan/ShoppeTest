<template>
  <div class="auth">
    <form class="auth__form" @submit.prevent="handleSubmit">
      ...
      <ButtonComp class="auth__form-button" size="xl" variant="primary" type="submit">
        SIGN IN
      </ButtonComp>
    </form>

    <NuxtLink to="/resetpass" class="auth__link"> Have you forgotten your password? </NuxtLink>
