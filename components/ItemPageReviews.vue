<template>
  <div class="reviews">
    <div class="reviews__list">
      <h3 class="reviews__title">{{ NUMBER_OF_ANSWERS }} Reviews for {{ title }}</h3>
    ...
    <div class="reviews__form">
      ...
      <form class="reviews__form-content" @submit.prevent="handleSubmit(form)">
        <DefaultTextInput
        ...
        <ButtonComp variant="primary" size="m" class="reviews__form-button" type="submit"
          >Submit
        </ButtonComp>
      </form>
    </div>
...
<script lang="ts" setup>
  ...
  const { isModalOpen, status, message, modalOpen, modalClose } = useNotification()
